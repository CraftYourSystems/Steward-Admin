...
import { ArrowRight, ChevronLeft, Eye, EyeOff, Loader2, Store, Check } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const onSubmit = async (values: RegisterForm) => {
    ...
    try {
      ...
      setServerError(err?.response?.data?.error?.message ?? err?.response?.data?.message ?? 'Registration failed. Please try again.');
    }
  };
        ...
        <div className="w-full max-w-[400px] rounded-2xl border border-border bg-surface p-8 shadow-sm space-y-6 text-center">
          <div className="flex flex-col items-center gap-4 py-4">
            ...
            <p className="text-[12px] text-fg-subtle leading-relaxed">
              Click the link in the email to activate your account. Once verified, you&apos;ll be able to sign in.
            </p>
            <div className="w-full pt-4 space-y-3">
              ...
              {resendSent ? (
                <p className="text-[12px] text-success text-center">(sent) Email sent - check your inbox.</p>
              ) : (
                <button
      ...
      <div className="flex flex-col px-6 py-8 lg:px-16 lg:py-12">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-[400px]">
            <div className="mb-7">
              ...
              <p className="text-[13px] text-fg-muted mt-1.5">Get started in under a minute. No credit card required.</p>
            </div>
            ...
            <div className="relative flex items-center gap-3 mb-5">
              ...
              <span className="text-[11px] text-fg-subtle font-medium uppercase tracking-widest">or register with email</span>
              <div className="flex-1 h-px bg-border" />
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
              <div className="space-y-1.5">
                ...
                <Input id="restaurantName" placeholder="The Spice Garden" autoComplete="organization" {...register('restaurantName')} />
                {errors.restaurantName && <p className="text-[11px] text-danger mt-1">{errors.restaurantName.message}</p>}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input id="ownerName" placeholder="Priya Sharma" autoComplete="name" {...register('ownerName')} />
                {errors.ownerName && <p className="text-[11px] text-danger mt-1">{errors.ownerName.message}</p>}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <Input id="reg-email" type="email" placeholder="you@restaurant.com" autoComplete="email" {...register('email')} />
              ...
              <div className="space-y-1.5">
                ...
                {errors.password ? (
                  ...
                  <p className="text-[11px] text-fg-subtle mt-1">At least 8 chars, 1 uppercase, 1 number.</p>
                )}
              </div>
        ...
        <div className="flex items-center justify-between text-[11px] text-fg-subtle">
          ...
          <div className="flex items-center gap-4">
            <span className="hover:text-fg-muted cursor-not-allowed" title="Coming soon">
              Privacy
            </span>
            <span className="hover:text-fg-muted cursor-not-allowed" title="Coming soon">
              Terms
          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-[13px] text-fg-muted max-w-sm leading-relaxed">
                One registration creates your restaurant profile, your admin account, and unlocks full KDS, menu management,
                staff tools, and real-time analytics.
              </p>
            </div>
