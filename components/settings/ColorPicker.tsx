    ...
    <div className="relative inline-block">
      ...
      >
        <span
          ...
          style={hasValue ? { background: value } : undefined}
        />
        <span className="font-mono">{hasValue ? value : "None"}</span>
      </button>
      {open && (
        <div className="absolute left-0 top-10 z-50 rounded-xl border border-border bg-surface p-3 shadow-elevated space-y-3 w-56">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex-1 rounded-md border border-border bg-surface-2 py-1.5 text-[12px] font-medium text-fg-muted hover:bg-surface-3 hover:text-fg transition-colors"
            >
              Clear
            </button>
            <button
              ...
              className="flex-1 rounded-md bg-surface-3 py-1.5 text-[12px] font-medium text-fg-muted hover:text-fg transition-colors"
            >
              Done
            </button>
          </div>
