...
interface DashboardRevenueChartProps { data?: RevenueDataPoint[]; loading?: boolean; }

export const DashboardRevenueChart = memo(function DashboardRevenueChart({ data, loading }: DashboardRevenueChartProps) {
        ...
        <ResponsiveContainer width="100%" height={220}>
          <AreaChart data={formatted} margin={{ top: 5, right: 5, bottom: 0, left: 0 }}>
            ...
            <Area type="monotone" dataKey="revenue" stroke={ACCENT} strokeWidth={2}
              fill="url(#dashboardRevenueGrad)" dot={false}
