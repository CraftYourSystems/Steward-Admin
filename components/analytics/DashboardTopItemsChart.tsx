...
interface DashboardTopItemsChartProps { data?: TopItem[]; loading?: boolean; }

export const DashboardTopItemsChart = memo(function DashboardTopItemsChart({ data, loading }: DashboardTopItemsChartProps) {
